...
const Navbar = ({ isDarkMode, setIsDarkMode }) => {
  ...
  useEffect(() => {
    // Prevent horizontal scroll caused by side menu
  ...
  return (
    <>
      ...
      >
        ...
        <ul
          ref={sideMenuRef}
          className="flex md:hidden flex-col gap-4 py-20 px-10 fixed right-0 top-0 bottom-0 w-64 z-50 h-screen font-medium bg-rose-50/90 transition-transform duration-500 transform translate-x-full dark:bg-darkHover dark:text-white"
        >
